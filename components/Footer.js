                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    <div className="md:col-span-2">
                        ...
                        <div className="flex space-x-4">
                            <a href="https://www.instagram.com/nexus.atencion?igsh=eXZmdHE3eDNqcXEy&utm_source=qr" target="_blank" rel="noopener noreferrer" aria-label="Instagram de Nexus" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-nexus-purple transition text-gray-400 hover:text-white">
                                <div className="icon-instagram text-xl"></div>
                            </a>
                            <a href="https://x.com/nexus26ur?s=11&t=Ej9EWtPXOCY635Ey8IToug" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter) de Nexus" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-black transition text-gray-400 hover:text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-twitter-x" viewBox="0 0 16 16">
                                    <path d="M12.6.75h2.454l-5.36 6.142L16 15.25h-4.937l-3.867-5.07-4.425 5.07H.316l5.733-6.57L0 .75h5.063l3.495 4.633L12.601.75Zm-.86 13.028h1.36L4.323 2.145H2.865z"/>
                                </svg>
                            </a>
                            <a href="https://wa.me/5215573008401?text=Hola,%20me%20interesa%20hacer%20mi%20página" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp de Nexus" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-green-500 transition text-gray-400 hover:text-white">
                            ...
                            <button onClick={() => setCurrentView('contact')} aria-label="Ir a contacto" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center hover:bg-nexus-blue transition text-gray-400 hover:text-white">
